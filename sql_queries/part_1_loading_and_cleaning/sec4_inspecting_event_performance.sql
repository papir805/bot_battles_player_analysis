...
SELECT first_dates.event_date AS earliest_dates
       , last_dates.event_date AS latest_dates
FROM first_dates
INNER JOIN last_dates
  ON first_dates.rn = last_dates.rn
ORDER BY first_dates.event_date ASC, last_dates.event_date ASC;
