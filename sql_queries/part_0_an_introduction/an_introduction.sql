...
SELECT COUNT(DISTINCT userid) AS num_players
FROM users;
...
-- event last year?
SELECT COUNT(DISTINCT userid) AS num_participating_players
...
SELECT COUNT(DISTINCT event_date) AS num_gaming_events
FROM event_performance;
